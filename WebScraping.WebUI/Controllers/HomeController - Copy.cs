...
namespace WebScraping.WebUI.Controllers
{
    ...
    public class HomeControllerCopy : Controller
    {
        ...
        Dictionary<string, string> _booksLogoUrl = new Dictionary<string, string>()
        {
                ...
                //{"Kitap Yurdu", "https://img.kitapyurdu.com/v1/getImage/fn:11273480/wh:dde122cd5"},
                ...
                {"Egenba","https://www.eganba.com/wwwroot/images/eganba-logo.png"},
        ...
        private void Book()
        {
            WebRequest myWebRequest = WebRequest.Create("https://www.amazon.com.tr");
            ...
            List<string> websitesUrl = new List<string>()
            {
                ...
                //"https://www.kitapyurdu.com/index.php?route=product/bestseller_ten_year&page=2",
            ...
            foreach (var url in websitesUrl)
            {
                ...
                //else if (url.Contains("kitapyurdu"))
                //{

                //    var bookNameNode = doc.DocumentNode.SelectNodes("//div[@class='name ellipsis']/a/span");
                //    var bookPriceNode = doc.DocumentNode.SelectNodes("//div[@class='price-new ']/span[@class='value']/text() | //span[@class='price-old ']/span[2]/text()");
                //    var bookImageNode = doc.DocumentNode.SelectNodes("//a[@class='pr-img-link']/img");
                //    var bookDetailNode =
                //        doc.DocumentNode.SelectNodes(
                //            "//a[@class='pr-img-link']");
                //    foreach (var node in bookDetailNode)
                ...
                //    string websiteName = "Kitap Yurdu";
                //    foreach (var bookDetailUrl in BookDetailUrl)
                //    {
                //        HtmlDocument document = web.Load(bookDetailUrl);
                //        BookDetailsNode.Add(document.DocumentNode.SelectNodes(
                //            "//div[@class='pr_producers__publisher']/div/a"));
                //    }
        ...
        public ActionResult Search(string query)
        {
            ...
            if (!String.IsNullOrEmpty(query))
            {
                var otherPublishers = _books.Where(b => b.Name.ToUpper()
                    ...
                    .GroupBy(b => new { b.Name, b.Publisher })
                ...
                var distinct = _books.Where(b => b.Name.ToUpper().Contains(query.ToUpper()))
        ...
        public void GetBookPublisher(List<string> urls, string websiteName)
        {
            ...
            Parallel.ForEach(urls, new ParallelOptions { MaxDegreeOfParallelism = 4 }, link =>
              {
